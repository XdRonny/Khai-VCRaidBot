...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open(f"Tech-Quard/choose/rrc.png")
    ...
    font = ImageFont.truetype("Tech-Quard/choose/Roboto-Light.ttf", 55)
    font2 = ImageFont.truetype("Tech-Quard/choose/finalfont.ttf", 65)
    draw.text(
        (20, 630),
        f"{title[:25]}...",
        fill="White",
